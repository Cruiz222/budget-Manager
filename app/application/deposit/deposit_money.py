...
class DepositMoney:
    ...
    def execute(self, amount: Money) -> Transaction:
        ...
        # 2. Record intent BEFORE touching money. The attempt is persisted as
        ...
        try:
            # 3. The wallet is the authority on whether this deposit is allowed.
            #    It validates and raises before mutating its balance.
            self.wallet.apply_deposit(amount)
        except MoneyError:
            # 3a. The wallet rejected the deposit (closed wallet, wrong currency,
        ...
        # 3b. The money moved successfully - the transaction is complete.
